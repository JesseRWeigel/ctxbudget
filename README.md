...
Context budget calculator: what fills a model context window, what is left for the response, and what to cut first

Catalog task: `CLI-034`. One of a public catalog of build ideas: https://github.com/JesseRWeigel/722-things-to-build
